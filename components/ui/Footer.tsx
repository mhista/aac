      ...
      <div className="wrap py-20 md:py-24">
        ...
        <div className="mt-16 grid gap-8 border-t border-[var(--color-border-inverse)] pt-10 md:grid-cols-3">
          <div>
            ...
            <a href={`mailto:${ORG.email.general}`} className="text-body text-white underline-offset-4 hover:underline">
              {ORG.email.general}
            </a>
          </div>
          <div>
            <h2 className="mono mb-3 !text-[var(--color-violet-300)]">Patient &amp; survivor support</h2>
            <a href={`mailto:${ORG.email.support}`} className="text-body text-white underline-offset-4 hover:underline">
              {ORG.email.support}
            </a>
          </div>
          <div>
